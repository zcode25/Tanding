        ...
        <div class="col-xl-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Form Create Event</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/superadminEvent/store" method="POST" class="form-horizontal">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control @error('event_desc') is-invalid @enderror" rows="3" id="event_desc" name="event_desc">{{ old('event_desc') }}</textarea>
                    @error('event_desc') 
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
