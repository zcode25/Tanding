      ...
      <div class="row">
        <div class="col-xl-6">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/superadminPayment/update/{{ $payment->paymentmethod_id }}" method="POST" class="form-horizontal">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('account_number') is-invalid @enderror" id="account_number" name="account_number" value="{{ old('account_number', $payment->account_number) }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('account_holder') is-invalid @enderror" id="account_holder" name="account_holder" value="{{ old('account_holder', $payment->account_holder) }}">
