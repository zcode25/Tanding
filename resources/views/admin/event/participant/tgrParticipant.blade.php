        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-8">
              <div class="d-flex justify-content-end align-items-center">
                  ...
                  {{-- <a href="/adminParticipant/tgrDraw/{{ $competition->competition_id }}" class="btn btn-primary">Pengundian</a> --}}
              </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="/adminParticipant/tgrParticipant/store" method="POST" class="form-horizontal">
              @csrf
              <div class="card-body">
                  <div class="row">
                      <div class="col-xl-6">
