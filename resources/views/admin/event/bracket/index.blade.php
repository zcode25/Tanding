            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                      <td>{{ $groupedAge->category->category_name }}</td>
                      <td>{{ $groupedAge->age->age_name }}</td>
                      <td>{{ $groupedAge->gender }}</td>
                      <td class="py-0 align-middle">
                        <a href="/adminBracket/detail/{{ $groupedAge->competition_id }}"" class="btn btn-dark btn-sm">Detail<i class="fa fa-eye ml-2" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                    @endforeach
                </tfoot>
