                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="py-0 align-middle">
                        <a href="/adminBracket/tanding/{{ $competition->competition_id }}/{{ $groupedClass->class_id }}" class="btn btn-dark btn-sm">Detail<i class="fa fa-eye ml-2" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                    @endforeach
                </tfoot>
