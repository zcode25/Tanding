                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="py-0 align-middle">
                        ...
                        <a href="/adminMatch/tanding/{{ $groupedAge->competition_id }}"" class="btn btn-dark btn-sm">Detail<i class="fa fa-eye ml-2" aria-hidden="true"></i></a>
                        @else
                        <a href="/adminMatch/tgrMatch/{{ $groupedAge->competition_id }}"" class="btn btn-dark btn-sm">Detail<i class="fa fa-eye ml-2" aria-hidden="true"></i></a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
