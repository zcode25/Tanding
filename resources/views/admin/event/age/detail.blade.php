      ...
      <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/adminEvent/class/store" method="POST" class="form-horizontal">
                @csrf
                ...
                <tbody>
                  @foreach ($classes as $class)
                    <tr>
                      ...
                      <td>
                          <a href="/adminEvent/class/destroy/{{ $class->class_id }}" class="btn btn-danger btn-sm" data-confirm-delete="true">Hapus<i class="fa fa-trash ml-2" aria-hidden="true"></i></a>
                      </td>
                    </tr>
                  @endforeach
                </tfoot>
