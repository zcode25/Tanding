          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="text-center mb-3">
                @if (count($draws) > 0)
                <form action="/adminDraw/tgrDraw/reshuffle" method="POST" class="form-horizontal d-inline">
                  @csrf
                ...
                @else
                <form action="/adminDraw/tgrDraw/store" method="POST" class="form-horizontal">
                  @csrf
                  <input type="hidden" id="event_id" name="event_id" value="{{ $event->event_id }}">
                  <input type="hidden" id="category_id" name="category_id" value="{{ $category_id }}">
                  <input type="hidden" id="age_id" name="age_id" value="{{ $age_id }}">
