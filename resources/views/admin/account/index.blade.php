      ...
      <div class="row">
        <div class="col-xl-6">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/adminAccount/update/{{ $admin->id }}" method="POST" class="form-horizontal">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                  {{-- <a href="/adminAdmin" class="btn btn-default">Cancel</a> --}}
        ...
        <div class="col-xl-6">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="/adminAccount/reset-password/{{ $admin->id }}" method="POST" class="form-horizontal">
              @csrf
              <div class="card-body">
                <div class="form-group">
